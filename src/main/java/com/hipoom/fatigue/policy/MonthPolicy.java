...
/**
 * @author ZhengHaiPeng
 * @since 2024/5/25 22:53
 */
public class MonthPolicy extends FatiguePolicyOptions {

    /* ======================================================= */
    /* Constructors or Instance Creator                        */
    /* ======================================================= */

    public MonthPolicy(int times, int period) {
        super(times, period);
    }
    ...
    private int findCount(long now, List<Record> records, int period) {
        ...
        for (Record record : records) {
            ...
            // 计算天数差距
            long monthsDiff = info.monthIndex - time.monthIndex;
            if (monthsDiff < period) {
                count++;
            }
        }
